    ...
    <ul>
        ...
        <li><a href="<?=DOWNLOAD_URL?>Book_Release.pdf" target="_blank">Book Release</a></li>
        <li><a href="<?=DOWNLOAD_URL?>Cultural_Event.pdf" target="_blank">Cultural Event</a></li>
        <li><a href="<?=DOWNLOAD_URL?>Pocket_Book.pdf" target="_blank">Pocket Book</a></li>
        <li><a href="<?=DOWNLOAD_URL?>Programme_Poster.pdf" target="_blank">Programme</a></li>
        <li><a href="<?=DOWNLOAD_URL?>Public_Lectures.pdf" target="_blank">Public Lectures</a></li>
